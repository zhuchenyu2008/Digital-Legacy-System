...
export interface InitOutput {
    ...
    readonly combinePedersen: (a: any, b: number, c: number, d: number, e: number) => [number, number, number, number];
    readonly splitPedersen: (a: number, b: number, c: number, d: number, e: number, f: number) => [number, number, number];
    readonly verifyPedersenShare: (a: number, b: number, c: number, d: number, e: number, f: number) => number;
