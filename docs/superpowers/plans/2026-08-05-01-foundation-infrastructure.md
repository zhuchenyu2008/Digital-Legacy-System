...
- [ ] **Step 1: Write the failing pin-policy test**
...
- [ ] **Step 2: Run and see it fail on missing manifests**

```powershell
pnpm.cmd exec vitest run tests/architecture/dependency-boundaries.test.ts
```

- [ ] **Step 3: Create manifests, references, and public entry points**
...
- [ ] **Step 4: Verify graph and type checking**
...
- [ ] **Step 3: Implement parsing with Zod**
...
- [ ] **Step 4: Document development secret generation**
...
- [ ] **Step 1: Add failing process-level health tests**
...
- [ ] **Step 3: Implement minimal bootstraps**
...
- [ ] **Step 4: Verify the processes without Docker**
...
- [ ] **Step 5: Commit process skeletons**
...
- [ ] **Step 2: Run and observe the missing-Compose failure**
...
- [ ] **Step 4: Add cross-platform smoke scripts**
...
- [ ] **Step 5: Verify default and optional profiles**
...
- [ ] **Step 6: Commit container topology**
...
- [ ] **Step 4: Verify generated output and production builds**
